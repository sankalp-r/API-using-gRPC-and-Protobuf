...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x8a, 0xe1, 0xe2, 0x72, 0x4c, 0x49, 0x09, 0x86, 0x98, 0x2d, 0xa4, 0xc6, 0xc5, 0xec, 0x98, 0x92,
	0x22, 0xc4, 0x07, 0xb1, 0x44, 0x0f, 0x6a, 0xb4, 0x14, 0x3f, 0x9c, 0x0f, 0x35, 0x43, 0x8d, 0x8b,
	0x39, 0xb8, 0x34, 0x89, 0xa0, 0xba, 0x24, 0x36, 0x30, 0xdf, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff,
	0x13, 0xb8, 0x14, 0xa8, 0xbd, 0x00, 0x00, 0x00,
}
...
func (*UnimplementedAddServiceServer) Sub(ctx context.Context, req *Request) (*Response, error) {
...
func _AddService_Sub_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).Sub(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
